...
<body>
    ...
    <?php
        ...
        $sql = "SELECT * FROM usuario WHERE excluido = false AND upper(nome) LIKE upper('%$search%') OR upper(email) LIKE upper('%$search%') AND excluido = false";
        ...
        if ($line >= 1)
        {
            ...
            echo "
                <div class='buttons'>
                    ...
                    <a href='search_user.php' class='button end'>Voltar</a>
                </div>
                </section>  
            ";
        ...
        else
        {
            ...
            <section class='table'>
                <div class='warning'>
                    ...
                    <a class='button back' href='search_user.php'>Voltar</a>
                <div>
            </section>";
        }
    ?>
